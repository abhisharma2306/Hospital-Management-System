...
<html>
    ...
    <body background="o.jpg">
        ...
        <form action="receptionistloginlogic.jsp">
        <div align="center">    
            <table width="30%" height="70%" align="center" border="0" pxcellpadding="10" style=" background-color:rgba(255, 255, 255, 0.5); padding: 20px; border-radius: 7px;">
                ...
                <tr>
                    <td></td>
                    <td style="font-family: Verdana; font-size: 20px; color:#3399ff">RECEPTIONIST LOGIN PANEL</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
                ...
                <tr align="center">
                    ...
                    <td><input class="input1" type="text" name="rName" placeholder="Your name here" required></td>
                </tr>
                <tr><td><p></p></td></tr>
                <tr align="center">
                    <td style="color:white"><img src="a21.png" width="58px" height="55px"></td>
                    <td><input class="input1" type="password" name="rPass"  placeholder="Enter Password Here" required></td>                    
                </tr>
                <tr><td><p></p></td></tr>
                <tr align="center">
