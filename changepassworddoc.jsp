<html>
    ...
    <body background="o.jpg">
        ...
        <form action="changepasswordlogic.jsp">
            <table width="40%" align="center" border="0" pxcellpadding="10" style=" background-color: white; border-radius: 10px">
                ...
                <tr><td><p></p></td></tr>
                <tr align="center">
                    <td style="color:black">RE-ENTER NEW PASSWORD</td>
                        <td><input class="input1" type="password" name="rePass" placeholder="Enter Password Again Here" required></td>
                </tr>
                <tr><td><p></p></td></tr>
                <tr align="center">
                    <td colspan="2"><input class="input1" type="submit" value="DONE" style="border-radius: 20px;width:120px;height: 50px;background-color:black;color:white;font-size:20px;font-family: arial"></td>    
                </tr>
