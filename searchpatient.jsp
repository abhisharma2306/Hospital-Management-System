    ...
    <body background="o.jpg">
        ...
        <div>
            <table align="">
                ...
                <tr class="tdtheme">
                    <td style="border-radius: 10px; padding: 15px;">Search Patients</td>
                </tr> 
            </table>
        </div> 
                    ...
                    <form action="addpatientlogic.jsp">            
                        <table width="100%" align="center" border="0" pxcellpadding="10" style="border:inset; background-color: #ffffff; border-radius: 10px">
                            <tr align="center" bgcolor="black">
                                <td colspan="4" style="color:white">Search Patients</td>
                            </tr>
                            <tr><td><p></p></td></tr>
                            <tr align="center">
...
<!--                            <tr align="center">
                                <td colspan="4" ><button align="center" class="button" type="submit" formaction="abc.jsp" class="input1" type="submit" value="Add" style="border-radius: 20px;width:120px;height: 50px;background-color:black;color:white;font-size:20px;font-family: arial">Update</button></td>    
                            </tr>              -->
                        </table>
                    </form>   
